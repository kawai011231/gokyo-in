        ...
        <div class="l-container">
          ...
          <div class="ex_charm_wrap">
            <div class="ex_charm_head">
              <div class="sub_explanation_flag_wrap">
                <div class="sub_explanation_flag">
                  <img
                    src="<?= get_template_directory_uri(); ?>/img/crown.png"
                    alt=""
                    class="sub_explanation_flag_crown"
                  />
                  <p class="sub_explanation_flag_heading">
                    福井県の<br />名物料理
                  </p>
                  <p class="sub_explanation_flag_number">NO.<span>1</span></p>
                </div>
                <div class="sub_explanation_flag">
                  <img
                    src="<?= get_template_directory_uri(); ?>/img/crown.png"
              ...
              <div class="ex_charm_title">
                越前そば<span class="ex_charm_title_small">の</span><br />
