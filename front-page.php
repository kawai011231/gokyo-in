<?php get_header(); ?>
<main>
        <h1 class="top_h1">福井御蕎印プロジェクト越前そば</h1>
        <p class="top_text">
        ...
        <section class="insta">
          <div class="insta_wrap slide-paused">
            <ul class="slideshow">
              <li class="insta_element">
                <blockquote
                  class="instagram-media"
                  data-instgrm-permalink="https://www.instagram.com/p/CiKRTNSLocd/?utm_source=ig_embed&amp;utm_campaign=loading"
                ...
                >
                  <div style="padding: 16px">
                    <a
                      href="https://www.instagram.com/p/CiKRTNSLocd/?utm_source=ig_embed&amp;utm_campaign=loading"
                      style="
                        background: #ffffff;
                        line-height: 0;
                        padding: 0 0;
                    ...
                    >
                      <a
                        ...
                        "
                        target="_blank"
                        >御蕎印プロジェクト(@gokyoin_project)がシェアした投稿</a
                      >
                    </p>
                  </div>
                </blockquote>
          ...
          <div class="course_wrap">
            <div class="l-container">
              <div class="course_title_wrap">
                <h2 class="course_title section_title">＃モデルコース</h2>
              </div>
...
?>
              ...
              <?php endif; ?>
                ...
                <div class="cource_map_wrap">
                  ...
                  <div class="cource_map_btn_wrap">
                    <a href="" class="cource_map_btn cource_map_btn_awaraonsen"
                      ><img src="<?= get_template_directory_uri(); ?>/img/awaraonsen.png" alt=""
                    /></a>
                    <a href="" class="cource_map_btn cource_map_btn_tojinbou"
                      ><img src="<?= get_template_directory_uri(); ?>/img/tojinbou.png" alt=""
                    /></a>
                    <a href="" class="cource_map_btn cource_map_btn_maruokajo"
                      ><img src="<?= get_template_directory_uri(); ?>/img/maruokajo.png" alt=""
                    /></a>
                    <a href="" class="cource_map_btn cource_map_btn_eiheiji"
                      ><img src="<?= get_template_directory_uri(); ?>/img/eiheiji.png" alt=""
                    /></a>
                    <a
                      href=""
                      class="cource_map_btn cource_map_btn_kyouryuhakubutsukan"
                      ><img src="<?= get_template_directory_uri(); ?>/img/kyouryuhakubutsukan.png" alt=""
                    /></a>
                    <a href="" class="cource_map_btn cource_map_btn_ichijodani"
                      ><img src="<?= get_template_directory_uri(); ?>/img/ichijodani.png" alt=""
                    /></a>
                    <a
                      href=""
                      class="cource_map_btn cource_map_btn_echizenwashi"
                      ><img src="<?= get_template_directory_uri(); ?>/img/echizenwashi.png" alt=""
                    /></a>
                    <a href="" class="cource_map_btn cource_map_btn_kehijingu"
                      ><img src="<?= get_template_directory_uri(); ?>/img/kehijingu.png" alt=""
                    /></a>
                    <a
                      href=""
                      class="cource_map_btn cource_map_btn_uriwarinotaki"
                      ><img src="<?= get_template_directory_uri(); ?>/img/uriwarinotaki.png" alt=""
                    /></a>
                    <a href="" class="cource_map_btn cource_map_btn_mikatagoko"
                      ><img src="<?= get_template_directory_uri(); ?>/img/mikatagoko.png" alt=""
                    /></a>
                    <a href="" class="cource_map_btn cource_map_btn_sotomo"
